"""
Train SAC on MuJoCo Reacher using pixel observations.
...
3. Trains SAC with CnnPolicy and memory-safe replay settings.
4. Saves model, logs, and metadata.json.

How to run from Task-2:
python src/training/train_sac.py --timesteps 20000 --seed 7 --save-dir results/sac_seed7

Output files:
- <save-dir>/models/sac_reacher_pixels_seed_<seed>.zip
...
def main() -> None:
    ...
    print("=" * 70)
    print("Starting SAC training (Reacher pixels)")
