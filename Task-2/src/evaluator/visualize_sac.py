"""
Visualize a trained SAC agent on MuJoCo Reacher.

This script loads a trained SAC model and runs evaluation episodes while
...
# Task-2/src/evaluator/visualize_sac.py
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize a trained SAC model on MuJoCo Reacher."
    )
    parser.add_argument(
        "--model-path",
        type=str,
