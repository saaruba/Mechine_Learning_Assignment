"""
Visualize a trained SAC model on MuJoCo Reacher.
...
4. Loads a SAC model and runs evaluation episodes deterministically.

How to run from Task-2:
python src/evaluator/visualize_sac.py --model-path results/sac_seed7/models/sac_reacher_pixels_seed_7.zip --episodes 5 --seed 7 --sleep 0.05
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Visualize SAC on pixel-based MuJoCo Reacher.")
...
def main() -> None:
    ...
    print("=" * 70)
    print("SAC Reacher Visualization")
