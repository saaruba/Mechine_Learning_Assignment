"""
Visualize a trained PPO agent on MuJoCo Reacher.

This script loads a trained PPO model and runs evaluation episodes while
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize a trained PPO model on MuJoCo Reacher."
    )
    parser.add_argument(
        "--model-path",
        type=str,
